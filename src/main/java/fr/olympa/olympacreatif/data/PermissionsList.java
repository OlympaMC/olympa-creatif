...
public class PermissionsList {	
	public static final OlympaPermission CREA_USE_MICRO_BLOCKS = new OlympaPermission(OlympaGroup.CREA_CONSTRUCTOR);
	public static final OlympaPermission CREA_USE_PLOT_EXPORTATION = new OlympaPermission(OlympaGroup.CREA_CONSTRUCTOR);
	//public static final OlympaPermission CREA_USE_PLOT_RESET = new OlympaPermission(OlympaGroup.CREA_CONSTRUCTOR);
	
	public static final OlympaPermission CREA_USE_SKULL_COMMAND = new OlympaPermission(OlympaGroup.CREA_CONSTRUCTOR);
	public static final OlympaPermission CREA_USE_HAT_COMMAND = new OlympaPermission(OlympaGroup.CREA_CONSTRUCTOR);
	
	public static final OlympaPermission CREA_USE_WORLD_EDIT = new OlympaPermission(OlympaGroup.CREA_ARCHITECT);
	public static final OlympaPermission CREA_USE_PLOT_MUSIC = new OlympaPermission(OlympaGroup.CREA_ARCHITECT);
